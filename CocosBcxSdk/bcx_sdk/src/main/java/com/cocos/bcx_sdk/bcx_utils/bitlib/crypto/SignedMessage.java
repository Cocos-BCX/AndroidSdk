...
package com.cocos.bcx_sdk.bcx_utils.bitlib.crypto;

import com.cocos.bcx_sdk.bcx_utils.bitlib.crypto.ec.Curve;
import com.cocos.bcx_sdk.bcx_utils.bitlib.crypto.ec.EcTools;
...
import com.cocos.bcx_sdk.bcx_utils.bitlib.model.Address;
import com.cocos.bcx_sdk.bcx_utils.bitlib.util.BitUtils;
import com.cocos.bcx_sdk.bcx_utils.bitlib.util.ByteWriter;
import com.cocos.bcx_sdk.bcx_utils.bitlib.util.HashUtils;
...
public class SignedMessage implements Serializable {
    ...
    * @return public_key or null if recovery was not possible
    */
   ...
   /*
    * public static SignedMessage from(byte[] signature, public_key publicKey) {
