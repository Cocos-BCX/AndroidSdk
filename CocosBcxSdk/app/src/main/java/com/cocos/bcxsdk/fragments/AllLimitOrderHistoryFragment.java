 ...
 * @Date 2019/9/4
 */
public class AllLimitOrderHistoryFragment extends Fragment {


    private EditText transaction_pair;
    private EditText transaction_limit;
    private CheckBox is_subscribed;
    private TextView get_all_limit_orders_history;
    private RecyclerView rv_all_limit_history_orders;
    private EditText all_limit_orders_history_result;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_limit_order_history, null);
        ...
        get_all_limit_orders_history = v.findViewById(R.id.get_all_limit_orders_history);
        rv_all_limit_history_orders = v.findViewById(R.id.rv_all_limit_history_orders);
        all_limit_orders_history_result = v.findViewById(R.id.all_limit_orders_history_result);
        rv_all_limit_history_orders.setLayoutManager(new LinearLayoutManager(getContext()));
        int space = Utils.dip2px(20);
        rv_all_limit_history_orders.addItemDecoration(new SpacesItemDecoration(space));
        initData();
        return v;
    }
    ...
    private void initData() {
         ...
         *   get_limit_orders
         */
        get_all_limit_orders_history.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                try {
                    ...
                    rv_all_limit_history_orders.setAdapter(new TradeLimitOrderHistoryAdapter(getContext(), fill_order_history_objects));
                } catch (NetworkStatusException e) {
                    all_limit_orders_history_result.setText(e.getMessage());
